...
* [LH12] [paper](https://arxiv.org/pdf/1202.3890.pdf)
...
* [ALA16] Open problem
	...
	* What [ALA16] don't address in paper: planning for (complexity considerations? i.e. is this tractable? Kaelbling98)
	* In their paper they assume access to an optimization oracle that gives best memoryless planning policy at end of each episode. - No algorithm for this right now! <!--SoS? -->
	* First check if you can reduce from Nash equilibrium, etc.
...
* [S99] (not sure how open these are anymore!)
